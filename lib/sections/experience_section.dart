...
// 2. Mock Data (Replace with your actual data)
  ...
  // --- NEW INTEGRATED HEADER METHOD ---
  Widget _buildHeader(bool isDark) {
    return Column(
      children: [
        // THE NEW ANIMATED BADGE
        Container(
          ...
          child: Row(
            ...
            children: [
              const PingDot(), // Reusing the animated dot component
              const SizedBox(width: 8),
              Text(
                "PROFESSIONAL JOURNEY",
                style: GoogleFonts.spaceMono(
                  fontSize: 12, // Slightly smaller for the badge look
                  fontWeight: FontWeight.bold,
                  letterSpacing: 2,
                  color: isDark
...
// --- ANIMATED PING DOT COMPONENT (Ensure this is at the bottom of your file) ---
